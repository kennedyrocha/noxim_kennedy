...
void Power::rxSleep(unsigned long long int cycles)
{

    unsigned long long int sleep_start_cycle = (unsigned long long int)(sc_time_stamp().to_double()/GlobalParams::clock_period_ps);
...
bool Power::isSleeping()
{
    ...
    unsigned long long int now = (unsigned long long int)(sc_time_stamp().to_double()/GlobalParams::clock_period_ps);
