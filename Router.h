...
SC_MODULE(Router)
{
    ...
    unsigned long long int start_from_port; // Port from which to start the reservation cycle
    unsigned long long int routed_flits;
    ...
    unsigned long long int getRoutedFlits(); // Returns the number of routed flits
