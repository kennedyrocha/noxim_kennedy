...
/// Enumerates the MPI primitives - Moved to GlobalParams.h
...
struct Packet {
    ...
    unsigned long long int ts_start; // Trace start timestamp
    unsigned long long int ts_end;   // Trace end timestamp
    mpi_primitive_t primitive;  // Trace primitive
